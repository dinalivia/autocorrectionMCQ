// Got it from: https://github.com/spmallick/learnopencv/blob/master/Homography/homography_book.py
...
{
    // Read source image.
    Mat im_src = imread("../img/pi_cam/test12.jpg");

    int width = im_src.size().width;
    int height = im_src.size().height;
    Size size1(width/2, height/2);
    resize(im_src,im_src,size1);//resize image
